...
import { ProductImageSetting } from './ProductImageSetting'
...
const ProductImage: UserComponent<Partial<ProductImageProps>> = ({
  className
}) => {
  const {
  ...
  return (
    <div
      ...
      className="w-[540px] max-w-full p-2"
    >
      <Swiper
...
const ProductImageDefaultProps: Partial<ProductImageProps> = {}

ProductImage.craft = {
  displayName: 'Product Image',
  defaultProps: ProductImageDefaultProps,
  related: {
    settings: ProductImageSetting
  },
  rules: {}
}
